    ...
    public class AgencyController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Agency>>> GetAgenciesByAdminPost(int adminPostId)
        {
            var agencies = await _context.agencies
                ...
                .Include(a => a.bookings)
                .Include(a => a.accommodationDetails)
                .Where(a => a.adminPost.id == adminPostId)
                .ToListAsync();
        ...
        {
            var agencies = await _context.agencies
                .Where(a => a.agentRegister.Agent_Id == agentId)
                .ToListAsync();
        ...
        [HttpGet("GetagentIdByUsername")]
        public async Task<ActionResult<int>> GetagentIdByUsername(string username)
        {
            ...
            var user = await _context.agencies.FirstOrDefaultAsync(u => u.agentRegister.Agent_Name == username);
